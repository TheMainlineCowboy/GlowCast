...
const helperMarker = "function cleanMaskOutline(";
...
if (!source.includes("function cleanMaskCandidateOutlines(") || !source.includes("cleanMaskCandidateOutlines(")) {
  throw new Error("Mask cleanup helper and return wrapper were not both established");
}

if (changed) {
  await fs.writeFile(adapterPath, source);
  console.log("applied or repaired clean mask outline preparation");
} else {
  console.log("clean mask outline preparation already complete");
}
