...
if (start >= 0 && end > start) {
  const replacement = [
    ...
    '    }',
    '',
    '    const candidates = edgePointsToMaskCandidates(edgePoints, 12);',
    '    if (!candidates.length) {',
    '      setDetectMessage("No usable edge mask candidates were created yet. The scanner is working, but no stable components were found.");',
    '      return;',
    '    }',
    '',
    ...
    '    setDrawMode(false);',
    '    setDetectMessage("Created " + generated.length + " conservative edge mask candidates. Existing generated edge masks were replaced.");',
    '  }',
    ''
  ].join("\n");
