...
} else if (!source.includes("Pair ${overlapReviewPosition} of ${overlappingAutoMaskIds.size}")) {
...
console.log("Applied overlapping automatic-mask cleanup, review actions, pair-specific keep/remove tracking, and pair progress.");
