...
if (
  ...
  !source.includes("segmentContrastRetention >= 0.62") ||
  !source.includes("flankMean >= 0.4") ||
  !source.includes("secondaryGapGradientDirectionalAllowance * secondaryGapGradientStrengthCoherence")
) {
  throw new Error("Contrast-retention-aware strength-coherent sparse jitter resistance was not applied.");
}

await fs.writeFile(path, source);
console.log("Preserved coherent soft edge segments only when they retain local architectural contrast.");