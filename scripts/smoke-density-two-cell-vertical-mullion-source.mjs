...
if (source.includes("? [-1, 1].reduce((bestDensity, offset) => {")) {
  throw new Error("Two-cell vertical mullion regression failed: large openings reverted to centered-near-only recovery.");
}

console.log("Two-cell vertical mullion source smoke passed: large unequal-width openings require stronger two-cell divider evidence.");
